...
extern SEXP multiply_add_fma_         (SEXP a_, SEXP b_, SEXP c_);
extern SEXP multiply_add_unrolled_    (SEXP a_, SEXP b_, SEXP c_);
extern SEXP multiply_add_unrolled_fma_(SEXP a_, SEXP b_, SEXP c_);
...
static const R_CallMethodDef CEntries[] = {
  ...
  {"multiply_add_fma_"         , (DL_FUNC) &multiply_add_fma_         , 3},
  {"multiply_add_unrolled_"    , (DL_FUNC) &multiply_add_unrolled_    , 3},
  {"multiply_add_unrolled_fma_", (DL_FUNC) &multiply_add_unrolled_fma_, 3},
