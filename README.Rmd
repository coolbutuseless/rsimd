...
This means that CRAN probably won't currently accept a package using SIMDe
in its current version.

If you were to drop SIMDe and instead write custom SIMD for each platform and enable with `#ifdef`
statements, then the type errors would not occur, and CRAN should 
accept the package (if there are no other issues)
